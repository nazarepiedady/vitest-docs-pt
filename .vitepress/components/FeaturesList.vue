  ...
  >
    ...
    <ListItem>
      <a href="/guide/snapshot">
        Fotografia Compatível com a Jest
      </a>
    </ListItem>
    <ListItem>
      <a target="_blank" href="https://www.chaijs.com/" rel="noopener noreferrer">Chai</a> built-in for assertions + <a target="_blank" href="https://jestjs.io/docs/expect" rel="noopener noreferrer">Jest expect</a> compatible APIs
    </ListItem>
