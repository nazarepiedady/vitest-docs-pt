        ...
        <div class="vp-doc" flex flex-col items-center mt-10>
          ...
          <div grid="~ cols-1 lg:cols-2" w-full text-center mt-10>
            <div class="flex flex-col">
              <a text-lg h="32px" href="https://github.com/sponsors/antfu" rel="noopener noreferrer">Patrocinadores do Anthony</a>
          ...
          <p class="text-center opacity-75">
            <a href="https://www.netlify.com" rel="noopener noreferrer">
              <img src="/netlify.svg" alt="Implementada pela Netlify" width="114" height="151" decoding="async">
            </a>
          </p>
        </div>
      </main>
